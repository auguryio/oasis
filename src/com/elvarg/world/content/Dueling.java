...
public class Dueling {
	...
	public void duelLost() {
		...
		if(validate(player, interact, null, new DuelState[]{DuelState.STARTING_DUEL, DuelState.IN_DUEL})) {
			...
			//Move players home			
			interact.moveTo(GameConstants.DUEL_POSITION.copy().add(Misc.getRandom(2), Misc.getRandom(2)));
			player.moveTo(GameConstants.DUEL_POSITION.copy().add(Misc.getRandom(2), Misc.getRandom(2)));
